...
<%--        <button type="submit" class="btn btn-secondary" onclick="myFunction()"><s:property value="nameSection"/>--%>
<%--            <s:param name="handle"> nameSection </s:param>--%>
<%--        </button>--%>
<%--        &lt;%&ndash;        <s:property value="id"/>&ndash;%&gt;--%>
<%--&lt;%&ndash;        <s:action name="books" namespace="/" executeResult="false"></s:action>&ndash;%&gt;--%>

<%--        &lt;%&ndash;      <s:bean name="com.mkyong.common.Person" var="bookBean">&ndash;%&gt;--%>
<%--&lt;%&ndash;        <s:param name="id" value="%{section.id}"/>&ndash;%&gt;--%>
<%--        &lt;%&ndash;        </s:bean>&ndash;%&gt;--%>
